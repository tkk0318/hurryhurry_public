...
public class PagingForSR {
	...
	public PagingForSR(int nowPage, int rowTotal, int blockList, int blockPage, String searchType, String searchValue) {
		...
		*/
		...
		if(isPrePage) {
			sb.append("<li><a href='searchReview?searchType=");
